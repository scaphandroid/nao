...
class NAOSendMail
{
    ...
    public function sendMail(User $user, $validation) {
        ...
        if ($validation) {
            $this->message->setBody('<p>Bonjour,</p><p>Votre compte naturaliste est validé. Vous pouvez vous <a href="http://raphaeloff.net/nao/web/connexion">connecter</a> dès maintenant et valider les observations des particuliers.</p><p>A bientôt.</p><p>Nos Amis les Oiseaux</p>', 'text/html');
        }
        else {
